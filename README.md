...
I have attached a link to Google Drive as the Figma link would not allow a proper visualization of the wireframe unless with a Figma link and the pdf generated by Figma was too big to be loaded into GitHub, even if compressed.
