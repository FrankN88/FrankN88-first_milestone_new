...
#### Skeleton 
Wireframe mockups were created in a [Figma Workspace](https://drive.google.com/file/d/1rfLg4xM8hUs_Ci3eZZie8JvEilMZ3DSf/view?usp=sharing).
I have attached a link to Google Drive as the Figma link would not allow a proper visualization of the wireframe unless with an active Figma account; the pdf generated by Figma was too big to be loaded into GitHub too, even if compressed.
